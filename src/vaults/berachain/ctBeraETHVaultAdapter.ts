...
export class CtBeraETHVaultAdapter extends BaseAdapter {
    constructor() {
        super({
            name: "CtBeraETHVaultAdapter",
            description:
                "Adapter for the Concrete - BeraETH vault. Users receive ctBeraETH by depositing BeraETH into Concrete’s Berachain Ethereum vault. Vault: 0x49BEE393825BBAC404fEfE6E24f34854f30905D2.",
            enabled: true,
        });
    }
