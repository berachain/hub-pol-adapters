...
export class CtBeraWBERAVaultAdapter extends BaseAdapter {
    constructor() {
        super({
            ...
            description:
                "Adapter for the Concrete - BERA vault. Users receive ctBeraWBERA by depositing BERA or WBERA into Concrete’s Berachain Bera vault. Vault: 0xEC577E989c02b294D5b8f4324224a5B63F5beef7.",
            enabled: true,
        });
    }
